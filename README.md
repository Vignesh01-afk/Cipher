...
3. **There is no password reset.** The password derives the only key that can unlock the vault. Losing it means losing the notes. This is a property of correct end-to-end encryption, not a bug.
